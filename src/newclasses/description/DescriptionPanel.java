        ...
        if (descriptionPreview == null) {
            descriptionPreview = new JPanel() {
                ...
                public void paint(Graphics g) {
                    ...
                    BufferedImage img = DescriptionBuilder.getMonsterDescrBuilder().getDescriptionImage(getTextArea().getText());

                    g2d.drawImage(img, 0, 0, null);

//                    int[][] img2Pixels = PixelUtils.convertTo2DWithoutUsingGetRGB(img);

//                    g2d.drawImage(img2, 100, 0, null);
...
//                    saveImage(img);
    ...
    public static void main(String[] args) throws IOException {
        ...
        //</editor-fold>
        DescriptionPanel frame = new DescriptionPanel();
